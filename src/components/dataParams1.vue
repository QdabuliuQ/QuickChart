            ...
            <div class="optionBtn">
              <el-button-group>
                <el-button
                  ...
                  >编辑</el-button
                >
                <el-button @click="deleteData(index)" size="small" type="danger"
                  >删除</el-button
                >
              </el-button-group>
            </div>
          </div>
          <div @click="addSeriesData" class="addDataItem">
            <i class="iconfont i_plus"></i>
            添加数据项
          </div>
        </div>
        <div class="dataItem asisData">
          <div class="itemTitle">X轴数据</div>
          <div class="itemTip">编辑X轴的各项数据</div>
          <div v-for="(item, index) in common.option.xAxis" :key="index" class="item">
            <div class="optionTitle">
              <i class="iconfont i_X"></i>
              <div :title="item.name">{{ item.name != '' ? item.name : '未命名'+(index+1) }}</div>
            </div>
            <div class="optionBtn">
              <el-button-group>
                <el-button
          ...
          <div @click="addXasis" v-if="common.option.xAxis.length != 2" class="addDataItem">
            <i class="iconfont i_plus"></i>
            添加X轴
          </div>
        </div>
