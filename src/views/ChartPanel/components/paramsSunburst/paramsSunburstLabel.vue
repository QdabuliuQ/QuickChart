...
import { align, fontFamily, fontStyle, fontWeight } from '@/config/chart/constant'
...
const config = reactive<ConfigInt>({
	...
	rotate: {
		...
		value:
			seriesLabel.rotate != 'radial' && seriesLabel.rotate != 'tangential'
				? 'custom'
				: seriesLabel.rotate
	},
	rotate1: {
		...
		title: '旋转度数',
		value:
			seriesLabel.rotate == 'radial' || seriesLabel.rotate == 'tangential' ? 0 : seriesLabel.rotate
	},
	align: {
		type: 'select',
		options: align,
