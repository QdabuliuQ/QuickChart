<template>
	<div class="piecesOption">
		<div v-for="(item, idx) in pieces" :key="idx" class="piecesItem">
			<el-popover placement="right" :width="200" trigger="click">
				<template #reference>
					<el-button type="primary" title="修改" size="small">
						<i class="iconfont i_edit"></i>
					</el-button>
				</template>
				<div class="piecesDetail">
					...
					<series-item :title="'文本'">
						<el-input v-model="item.label" maxlength="20" type="text" size="small" />
					</series-item>
			...
			<el-button @click="piecesDelete(idx)" type="danger" title="删除" size="small">
...
const emits = defineEmits(['piecesAdd', 'piecesDelete', 'piecesChange'])
