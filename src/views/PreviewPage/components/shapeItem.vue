<template>
  <div
    ...
    :style="{
      ...
      transform: `translate(${getOffset(props.width, props.c_width, props.style.translateX)}px, ${getOffset(props.height, props.c_height, props.style.translateY)}px) rotate(${props.style.rotate}deg)`,
  ...
  >
    ...
    >
      <svg width="100%" height="100%">
        <g :transform="`scale(${getOffset(props.width, props.c_width, props.style.width) / props.viewBox[0]}, ${getOffset(props.height, props.c_height, props.style.height) / props.viewBox[1]}) translate(0,0) matrix(1,0,0,1,0,0)`">
          <path
